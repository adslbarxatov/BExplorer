...
Header files developed for this application technically supports a lot of manipulations (besides those described above)
with save files. They are available for use by developers who want to expand the functionality of this or own tools
